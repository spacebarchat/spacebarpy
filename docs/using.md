...
-   [Get Started](using/Get_Started.md)
    -   [installing fossbotpy](using/Get_Started.md#installing)
...
-   Start
    -   [request fosscord build number](using/REST_Actions.md#getbuildnumber)
    ...
    -   [get status of fosscord's servers](using/REST_Actions.md#getfosscordstatus)
    -   [get "detectables"](using/REST_Actions.md#getdetectables)
    -   [get OAuth2 tokens](using/REST_Actions.md#getoauth2tokens)
    -   [get hash of stable fosscord version](using/REST_Actions.md#getversionstablehash)
...
-   User
    ...
    -   [send friend request](using/REST_Actions.md#requestfriend)
    ...
    -   [change avatar](using/REST_Actions.md#setavatar)
    ...
    -   [fosscord analytics consent](using/REST_Actions.md#analyticsconsent)
    -   [allow fosscord to track screen reader usage](using/REST_Actions.md#allowScreenReaderTracking)
...
-   Guild
    ...
    -   [join guild](using/REST_Actions.md#joinguild)
...
-   Dms
    -   [privately message user(s) (create DM / DM Group)](using/REST_Actions.md#createdm)
