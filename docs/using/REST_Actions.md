...
- data (dict) - gets sent in the "data" key. Can use fossbotpy.utils.slash.SlashCommander to help with formatting the data.
- nonce (Optional[str]) - by default, this gets calculated

##### ```click```
```python
#message is a dict
from fossbotpy.utils.button import Buttoner
...
- guildID (str)
- nonce (Optional[str]) - by default, this gets calculated
- data (dict) - gets sent in the "data" key. Can use fossbotpy.utils.button.Buttoner to help with formatting the data.
__________
### Dms
##### ```createDM```
```python
...
##### ```Embedder```
```python
from fossbotpy.utils.embed import Embedder
embed = Embedder()
...
##### ```reply```
replies don't work yet in dms
```python
bot.reply('111111111111111','222222222222222222','000000000000000000', 'this is a reply', sticker_ids=['444444444444444444'], file="https://thiscatdoesnotexist.com/", isurl=True)
```
###### Parameters:
- guildID (str)
- channelID (str)
