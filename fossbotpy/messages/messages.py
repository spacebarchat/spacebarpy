...
class Messages(object):
	...
	def reply(self, guildID, channelID, messageID, message, nonce, tts, embed, allowed_mentions, sticker_ids, file, isurl):
		if file == None:
			self.sendMessage(channelID, message, nonce=nonce, tts=tts, embed=embed, message_reference={"guild_id":guildID,"channel_id":channelID,"message_id":messageID}, allowed_mentions=allowed_mentions, sticker_ids=sticker_ids)
		else:
